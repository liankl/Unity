...
public class AI : MonoBehaviour
{
    ...
    int i;
    private string BENQIANG;
    GameObject objname;
    // Use this for initialization  
    void Start()
    {
        objname = this.transform.Find("Bip01/Bip01 Pelvis/Bip01 Spine/Bip01 Spine1/Bip01 Spine2/Bip01 Neck/Bip01 R Clavicle/Bip01 R UpperArm/Bip01 R Forearm/Bip01 R Hand/B_RH/w_spear07_001nub").gameObject;
        Debug.Log("伍德objname："+objname);
        BENQIANG = objname.transform.tag;
        Debug.Log("伍德BENQIANG：" + BENQIANG);
        qiang = GameObject.FindGameObjectWithTag(BENQIANG);
